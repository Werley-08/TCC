...
\autor{Francisco Werley da Silva}
\titulo{Aplicação de Métricas Estruturais para Avaliação de Modularidade em Sistemas Orientados a Objetos: um estudo comparativo entre arquitetura em camadas e arquitetura hexagonal}
\data{2026}
\local{Quixadá}
...
\orientador{Prof. Dr. Emanuel Coutinho}
\orientadories{Universidade Federal do Ceará (UFC)}
% \orientadorcentro{Sistemas de Informação}
...
\begin{document}	
	...
	\input{2-textuais/5-objeto-de-estudo}
