...
sua modularidade. Diante disso, este trabalho tem como objetivo avaliar a modularidade de sistemas orientados a objetos por meio 
da aplicação de métricas estruturais em diferentes estilos arquiteturais. Para isso, será conduzido um estudo comparativo envolvendo 
...
considerando indicadores relacionados a acoplamento, coesão e complexidade estrutural. Espera-se que este trabalho contribua para 
a compreensão de como diferentes decisões arquiteturais podem se refletir em características estruturais mensuráveis de sistemas 
orientados a objetos. Além disso, busca-se fornecer evidências quantitativas que apoiem a análise da modularidade e auxiliem a adoção 
de práticas arquiteturais mais fundamentadas na Engenharia de Software.
