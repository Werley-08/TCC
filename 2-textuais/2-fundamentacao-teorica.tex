...
\citeonline{bass2012} observam que alguns sistemas permitem o acesso a camadas inferiores não adjacentes, situação conhecida
...
De forma complementar, \citeonline{fenton2015} associam a complexidade estrutural à complexidade das conexões entre os elementos de um modelo de sistema. 
...
A interpretação do \textit{Fan-In} não deve ser feita apenas de forma negativa. \citeonline{yourdon1978} observam que, em determinados 
...
Porém, \citeonline{yourdon1978} também ressaltam que o aumento do \textit{fan-in} não deve ocorrer a qualquer custo. Agrupar 
...
De modo semelhante, \citeonline{sommerville2011} define \textit{fan-out} como o número de funções chamadas por uma determinada 
